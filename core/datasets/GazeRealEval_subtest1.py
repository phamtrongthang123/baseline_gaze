...
import json
from .GazeReal_subtest1 import GazeReal_subtest1
from .GazeToy import GazeToy
from tqdm import tqdm

__all__ = ["GazeRealEval_subtest1"]


class GazeRealEval_subtest1(GazeReal_subtest1):
    def __init__(self, metadata, subtest, vocab, is_train=True):
        # init super
        super().__init__(metadata, subtest, vocab, is_train)
